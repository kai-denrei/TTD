...
describe('waves', () => {
  test('plan count follows wave.size and sizeGrowth', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('wave.size', 10); t.set('wave.sizeGrowth', 1);
  ...
  test('drip spreads spawns over time and is ordered', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('wave.size', 8); t.set('wave.dripRate', 0.5); t.set('wave.dripJitter', 0);
  ...
  test('dripRate 0.1 vs 2.0 is the difference between a burst and a trickle', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('wave.size', 10); t.set('wave.dripJitter', 0);
  ...
  test('jitter perturbs but keeps order and non-negativity', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('wave.size', 20); t.set('wave.dripRate', 0.5); t.set('wave.dripJitter', 0.9);
  ...
  test('spawns round-robin across gates', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('wave.size', 6);
  ...
  test('hp follows hpGrowth compounding per wave', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0); t.set('enemy.hp', 10); t.set('wave.hpGrowth', 1.1);
  ...
  test('overlap 0 waits for a clear before the next wave', () => {
    const t = makeTuning(); t.set('wave.buildTime', 0);
